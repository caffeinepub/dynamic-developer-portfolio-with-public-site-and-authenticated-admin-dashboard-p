...
import { LayoutDashboard, FolderKanban, Lightbulb, User, Briefcase, Link as LinkIcon, Mail, LogOut, Loader2, FileText, Image } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { setIntendedAdminPath, clearIntendedAdminPath } from '../../utils/adminRedirect';

export default function AdminLayout() {
  const { isAuthenticated, isLoading, logout, isLogoutPending } = useAdminSession();
  ...
  const adminLinks = [
    ...
    { path: '/admin/avatar', label: 'Avatar', icon: Image },
  ];
